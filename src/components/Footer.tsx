...
export default function Footer() {
  return (
    <footer className="w-full bg-[#063A26] border-t border-[#063A26] py-16 px-6 md:px-12 text-[#FAFAFA] text-sm relative z-20 overflow-hidden">
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#D4AF37] rounded-full blur-3xl opacity-10 transform translate-x-1/2 -translate-y-1/2"></div>
      
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        <div className="md:col-span-1">
           <div className="text-xl font-bold tracking-[0.2em] text-[#FAFAFA] mb-4 flex items-center">
             KUNLAJ&nbsp;<span className="text-[#D4AF37] font-light">AUTOS</span>
           </div>
        ...
        <div>
          <h4 className="text-xs font-bold tracking-[0.1em] text-[#D4AF37] uppercase mb-6">Inventory</h4>
        ...
        <div>
          <h4 className="text-xs font-bold tracking-[0.1em] text-[#D4AF37] uppercase mb-6">Operations</h4>
          <ul className="space-y-3 text-xs tracking-wide text-white/70">
        ...
        <div>
          <h4 className="text-xs font-bold tracking-[0.1em] text-[#D4AF37] uppercase mb-6">Legal & Connect</h4>
          <ul className="space-y-3 text-xs tracking-wide text-white/70">
            ...
            <li className="text-[#D4AF37] font-mono font-bold">+234 803 858 7752</li>
          </ul>
        </div>
      </div>
