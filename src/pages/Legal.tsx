export default function Legal() {
  return (
    <div className="w-full bg-[#FAFAFA] min-h-screen text-[#0A110D] py-24">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        <div className="mb-16 border-b border-[#E5E8E6] pb-8">
          <div className="flex items-center gap-3 mb-3">
             <span className="w-6 h-px bg-[#D4AF37]"></span>
             <span className="text-[10px] font-mono tracking-widest text-[#063A26] uppercase font-bold block">05 / DOCUMENTATION</span>
          </div>
          <h1 className="text-4xl font-light tracking-[0.02em] text-[#0A110D]">LEGAL FRAMEWORK</h1>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6 text-sm text-[#4A5F54] leading-relaxed">
            ...
            <h3 className="text-lg font-medium text-[#0A110D] pt-4 border-t border-[#E5E8E6]/50">1. Data Collection & WhatsApp Routing</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#0A110D] pt-4 border-t border-[#E5E8E6]/50">2. Jiji Platform Integrations</h3>
            <p>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6 text-sm text-[#4A5F54] leading-relaxed">
            <h3 className="text-lg font-medium text-[#0A110D] pt-4 border-t border-[#E5E8E6]/50">1. Vehicle Condition & Inspections</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#0A110D] pt-4 border-t border-[#E5E8E6]/50">2. Customs and Documentation</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#0A110D] pt-4 border-t border-[#E5E8E6]/50">3. Parts Sourcing Liability</h3>
            <p>
